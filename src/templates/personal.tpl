<div id="content">
	...
	{foreach key=key_wert item=item_wert from=$data_people}
		...
		<td height="23" width="131"><font size="1">{$item_wert.synetics_system_surname}</td>
		...
		<td height="23" width="131"><font size="1">{$item_wert.synetics_system_no}</td>
		...
		<td height="23" width="131""><font size="1">{$item_wert.synetics_system_mobile}</td>
