...
<div id="wrapper">
    ...
    <table width="100%"
        <tr>
        <img align="left" id="menu_start" src="images/menu/menu.png">
        <a href="javascript:window.location='?pageID=1'" id="m1"><img src="images/menu/menu-03.png"></a>
        <a href="javascript:window.location='?pageID=2'" id="m2"><img src="images/menu/menu-04.png"></a>
        ...
        <a href="javascript:window.location='?pageID=6'" id="m6"><img src="images/menu/menu-08.png"></a>
