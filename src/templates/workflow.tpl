    ...
    <tr id="noprint">
        <td height="auto" width="auto" colspan="13">
            <form method="POST" action="index.php?pageID=7" id="form_zeiten">
                ...
                <div class="execute_del" id="execute_del">
                    <img src="images/icon/delselected.png" title="Selektierte löschen">
                </div>
                <a href="#"title="Urlaub eintragen" id="holiday"><img src="images/icon/holiday.png" border="0" align="right"></a>
                <a href="#"title="Wochenende/Feiertag Eintragen" id="weekend"><img src="images/icon/briefcase.png" border="0" align="right"></a>
...
<br>
<div align="center" id="noprint">{$pagelink}</div><div align="right">Alle markieren<input type="checkbox" id="markall"></div>
<br>
<br>
