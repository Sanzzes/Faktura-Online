    ...
    switch ($weekend_select) {
        ...
        case 1:
            $mysql->query("INSERT INTO synetics_data (synetics_data_date,synetics_data_client,
					...
					synetics_data_projects_id,synetics_data_process_id) 
                                        VALUES ('" . $datum . "', '" . $settings['synetics_settings_weekendid'] . "', '" . $city . "', '1317765600', '1317765600', '1317765600', '1317765600', '1317765600', '1317765600', '1317765600', '1317765600','" . $_SESSION['user_id'] . "','1', '0');");
        ...
        case 2:
            $mysql->query("INSERT INTO synetics_data (synetics_data_date,synetics_data_client,
					...
					synetics_data_returnjourneyex,synetics_data_returnjourneyto,synetics_data_system_id,
					synetics_data_projects_id,synetics_data_process_id) 
                                        VALUES ('" . $datum . "', '" . $settings['synetics_settings_holidayid'] . "', '" . $city . "', '1317765600', '1317765600', '1317792600', '" . $worktime . "', '1317765600', '1317765600', '1317765600', '1317765600','" . $_SESSION['user_id'] . "','1', '0');");
            if (mysql_insert_id() > 0) {
                echo true;
            } else {
                echo false;
        ...
        case 3:
            $mysql->query("INSERT INTO synetics_data (synetics_data_date,synetics_data_client,
					...
					synetics_data_returnjourneyex,synetics_data_returnjourneyto,synetics_data_system_id,
					synetics_data_projects_id,synetics_data_process_id) 
                                        VALUES ('" . $datum . "', '" . $settings['synetics_settings_illid'] . "', '" . $city . "', '1317765600', '1317765600', '" . $worktime . "', '1317821400', '1317765600', '1317765600', '1317765600', '1317765600','" . $_SESSION['user_id'] . "','1', '0');");
            if (mysql_insert_id() > 0) {
                echo true;
            } else {
                echo false;
