...
$mysql->query("SELECT * FROM synetics_data WHERE synetics_data_system_id = '$workerID' AND synetics_data_date <= '$datum_ende' AND synetics_data_date >= '$datum_start' ORDER BY synetics_data_date LIMIT $pageNo,$maxShown");
...
$smarty->display('forms/weekend.tpl');
