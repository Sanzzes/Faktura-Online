...
<table border="0" width="442" height="472" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<?php foreach ($meinekunden AS $kunden_id => $kunden_bez)
					{				
		?>
					<option value="<?php echo $kunden_id; ?>">
					<?php echo $kunden_bez?>
					</option>
		<?php
					}
	...
	<tr>
		...
		<?php while ($personal=mysql_fetch_array($personal_result, MYSQL_ASSOC))
					{				
		?>
					<option value="<?php echo $personal['synetics_system__ID'] ?>">
					<?php echo $personal['synetics_system_name']?>
					</option>
		<?php
					}
